...
public class MemberDaoTest
{
    ...
    {
        User member = memberDao.findById(0l);
    ...
    {
        User member = memberDao.findByEmail("john.smith@mailinator.com");
    ...
    public void testRegister()
    {
        ...
        User newMember = memberDao.findById(id);
    ...
    public void testFindAllOrderedByName()
    {
        ...
        List<User> members = memberDao.findAllOrderedByName();
        Assert.assertEquals(2, members.size());
        User newMember = members.get(0);
